...
public class TrainingMaterialControllerITCase {
    ...
    public void shouldCreateTrainingMaterialWithPrevVersionInChain() throws Exception {
        ...
        mvc.perform(post("/api/training-materials")
                ...
                .andExpect(jsonPath("label", is("Test complex online course")))
                .andExpect(jsonPath("description", is("Lorem Ipsum ...")))
                .andExpect(jsonPath("historyPositions", hasSize(3)))
                .andExpect(jsonPath("historyPositions[0].id", is(7)))
                .andExpect(jsonPath("historyPositions[0].label", is("Introduction to GEPHI")))
                .andExpect(jsonPath("historyPositions[0].version", is("3.0")))
                .andExpect(jsonPath("historyPositions[1].id", is(6)))
                .andExpect(jsonPath("historyPositions[1].label", is("Introduction to GEPHI")))
                .andExpect(jsonPath("historyPositions[1].version", is("2.0")))
                .andExpect(jsonPath("historyPositions[2].id", is(5)))
                .andExpect(jsonPath("historyPositions[2].label", is("Introduction to GEPHI")))
                .andExpect(jsonPath("historyPositions[2].version", is("1.0")));
    }
