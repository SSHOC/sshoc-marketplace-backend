...
public class ItemRelationControllerITCase {
    ...
    public void shouldCreateItemsRelations() throws Exception {
        ...
        mvc.perform(get("/api/tools-services/{id}", subjectPersistentId)
                ...
                .andExpect(jsonPath("historyPositions[0].id", is(1)))
                .andExpect(jsonPath("historyPositions[0].label", is("Gephi")));
        ...
        mvc.perform(get("/api/tools-services/{id}", objectPersistentId)
                ...
                .andExpect(jsonPath("historyPositions", hasSize(1)))
                .andExpect(jsonPath("historyPositions[0].id", is(2)))
                .andExpect(jsonPath("historyPositions[0].label", is("Stata")));
    }
    ...
    public void shouldCreateAndDeleteItemsRelations() throws Exception {
        ...
        mvc.perform(get("/api/datasets/{id}", objectPersistentId)
                ...
                .andExpect(jsonPath("relatedItems[0].relation.code", is("is-mentioned-in")))
                .andExpect(jsonPath("historyPositions", hasSize(1)))
                .andExpect(jsonPath("historyPositions[0].id", is(11)))
                .andExpect(jsonPath("historyPositions[0].label", is("Test dataset with markdown description")));
        ...
        mvc.perform(get("/api/tools-services/{id}", subjectPersistentId)
                ...
                .andExpect(jsonPath("label", is("Stata")))
                .andExpect(jsonPath("relatedItems", hasSize(0)))
                .andExpect(jsonPath("historyPositions", hasSize(2)))
                .andExpect(jsonPath("historyPositions[1].id", is(2)))
                .andExpect(jsonPath("historyPositions[1].label", is("Stata")));
        ...
        mvc.perform(get("/api/datasets/{id}", objectPersistentId)
                ...
                .andExpect(jsonPath("relatedItems", hasSize(0)))
                .andExpect(jsonPath("historyPositions", hasSize(2)))
                .andExpect(jsonPath("historyPositions[1].id", is(11)))
                .andExpect(jsonPath("historyPositions[1].label", is("Test dataset with markdown description")));
    }
