...
import eu.sshopencloud.marketplace.repositories.common.ManagedEntitiesRepository;
import eu.sshopencloud.marketplace.repositories.items.ItemVersionRepository;
import org.springframework.stereotype.Repository;


@Repository
public interface WorkflowRepository extends ItemVersionRepository<Workflow>, ManagedEntitiesRepository<Workflow> {
}
