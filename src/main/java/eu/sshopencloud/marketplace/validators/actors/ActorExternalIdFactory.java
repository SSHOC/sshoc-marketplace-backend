...
public class ActorExternalIdFactory {
    ...
    public ActorExternalId create(ActorExternalIdCore externalId, Actor actor, Errors errors) {
        ...
        return actorExternalIdService.loadActorExternalId(actorSource.get(), externalId.getIdentifier(), actor).orElse(new ActorExternalId(actorSource.get(), externalId.getIdentifier(), actor));
