...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeRequests()
                .antMatchers(HttpMethod.POST, "/api/vocabularies/**").hasAnyAuthority(Authority.SYSTEM_CONTRIBUTOR.name(),Authority.MODERATOR.name())
                .antMatchers(HttpMethod.PUT, "/api/vocabularies/**").hasAnyAuthority(Authority.SYSTEM_CONTRIBUTOR.name(),Authority.MODERATOR.name())
